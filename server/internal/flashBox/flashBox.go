...
import (
	...
	"flash_box_server/pkg/version/verflag"
)

var cfgFile string

// NewFlashBoxCommand 创建一个 *cobra.Command 对象. 之后，可以使用 Command 对象的 Execute 方法来启动应用程序.
func NewFlashBoxCommand() *cobra.Command {
	cmd := &cobra.Command{
	...
	Find more flashBox information at:
	https://github.com/alwaysday1/flashBox#readme`,
	...
	cmd.PersistentFlags().StringVarP(&cfgFile, "config", "c", "", "The path to the flashBox configuration file. Empty string for no configuration file.")
...
func startGRPCServer() *grpc.Server {
	...
	pb.RegisterFlashBoxServer(grpcsrv, user.New(store.S, nil))
